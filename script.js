document.addEventListener("DOMContentLoaded", function () { let logBox = document.createElement("div"); logBox.style.position = "fixed"; logBox.style.bottom = "10px"; logBox.style.left = "10px"; logBox.style.backgroundColor = "white"; logBox.style.padding = "10px"; logBox.style.border = "1px solid black"; logBox.style.zIndex = "1000"; document.body.appendChild(logBox);
...
function updateProgress() {
    ...
    progressElement.style.backgroundColor = "#c8a400";
